...
void cons_exp() {
  ...
  std::cout << "1. example of the constant expression : " << max_files
            << std::endl;
...
void type_alias_pointe() {
  ...
  std::cout << "ps is a variable pointer to constant pointer to char"
            << std::endl;
}
void the_auto_spe() {
  auto x = 12;
  ...
  auto bi = ci;
  bi = 13;
  std::cout << "ignores top level const, bi variable can be modified : " << bi
            << std::endl;
...
void us_declty() {
  decltype(3 / 12.0) sum;
  std::cout << "using decltype to assign variable type from expression : "
            << std::endl;
  sum = 13.5;
  std::cout << "assign sum variable : " << sum << std::endl;
  std::cout << "decltype include the top level const not like auto "
            << std::endl;
