...
void str_compare(){
    ...
    std::cout<<"first string less than second string : " << (str<phrase)<<std::endl;
    std::cout<<"the second string less than the third string : " << (phrase<slang)
        <<std::endl;
}
void concate_str(){
...
void tranformRandom(const std::string hex){
    std::cout<<"Enter a series of numbers betweenn 0 and 15, separated by spaces"<<std::endl;
    std::string result;
